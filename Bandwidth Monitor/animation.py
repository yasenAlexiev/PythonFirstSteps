...
def create_buttons(root, plot_properties):
    ...
    button_cosine = tk.Button(root, text="Statistic from last 24 hour", command=lambda: on_select(plot_properties, "Statistic from last 24 hour"))
